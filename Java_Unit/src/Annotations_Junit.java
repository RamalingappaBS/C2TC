...
public class Annotations_Junit
{
	...
	public static void AfterClass()		//method should be static
	{
		...
		System.out.println(" I have learned @Test,@Test(timeout=100), @Before,@BeforeClass, @After, @AfterClass");
	}
	@Test
	...
	class DisabledDemo
	{
		...
		public void message()
		{
			System.out.println("Entire test classes or individual test methods can be disabled");
		}
	}
}