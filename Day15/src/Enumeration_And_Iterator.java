...
public class Enumeration_And_Iterator
{
		   ...
		   {
		      List list = new ArrayList(Arrays.asList( new String[] {"Java", "Microprocessor", "C++", "Python", "HTML &CSS" }));		     
		      Vector v = new Vector(list);
		      delete(v, "C++");
		   }
		   private static void delete(Vector v, String name)
		   {
			   		//enumeration has methods such as has MoreElements(), nextElement()
		      ...
		      while (e.hasMoreElements())
		      {
		         ...
		         System.out.println(e.nextElement());
		      		...
		      		//We can read and remove element while traversing element */9/89]/89\8s
